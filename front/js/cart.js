...
submitButton.addEventListener("click", (event) => {
    ...
    if (validFirstName(contact.firstName) == false || validFirstName(contact.firstName) == null || validLastName(contact.lastName) == false || validLastName(contact.lastName) == null || validCity(contact.city) == false || validCity(contact.city) == null || validAddress(contact.address) == false || validAddress(contact.address) == null || validEmail(contact.email) == false || validEmail(contact.email) == null && basket == null || basket == 0) {
